...
import { PolySceneWithNodeMap_bvh_demo_highlight_large_objects } from "./PolySceneWithNodeMap";
...
export interface LoadedData {
  scene: PolySceneWithNodeMap_bvh_demo_highlight_large_objects;
  viewer: BaseViewerType | undefined;
}
export type LoadScene_bvh_demo_highlight_large_objects = (
  options?: LoadSceneOptions
) => Promise<LoadedData>;

export const loadScene_bvh_demo_highlight_large_objects: LoadScene_bvh_demo_highlight_large_objects;
