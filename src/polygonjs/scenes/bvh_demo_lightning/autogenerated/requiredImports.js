...
import { setMaterialUniformVectorColor } from "@polygonjs/polygonjs/dist/src/engine/functions/setMaterialUniformVectorColor";
...
export const requiredImports_bvh_demo_lightning = {
  nodes: [
    EnvMapCopNode,
    ImageCopNode,
    ImageEXRCopNode,
