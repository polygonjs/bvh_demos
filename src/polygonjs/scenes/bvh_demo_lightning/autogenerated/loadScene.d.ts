...
import { PolySceneWithNodeMap_bvh_demo_lightning } from "./PolySceneWithNodeMap";
...
export interface LoadedData {
  scene: PolySceneWithNodeMap_bvh_demo_lightning;
  viewer: BaseViewerType | undefined;
}
export type LoadScene_bvh_demo_lightning = (
  options?: LoadSceneOptions
) => Promise<LoadedData>;

export const loadScene_bvh_demo_lightning: LoadScene_bvh_demo_lightning;
