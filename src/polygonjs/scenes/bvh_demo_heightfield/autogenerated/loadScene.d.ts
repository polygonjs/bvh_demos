...
import { PolySceneWithNodeMap_bvh_demo_heightfield } from "./PolySceneWithNodeMap";
...
export interface LoadedData {
  scene: PolySceneWithNodeMap_bvh_demo_heightfield;
  viewer: BaseViewerType | undefined;
}
export type LoadScene_bvh_demo_heightfield = (
  options?: LoadSceneOptions
) => Promise<LoadedData>;

export const loadScene_bvh_demo_heightfield: LoadScene_bvh_demo_heightfield;
