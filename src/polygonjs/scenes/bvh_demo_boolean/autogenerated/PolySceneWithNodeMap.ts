...
export class PolySceneWithNodeMap_bvh_demo_boolean extends PolyScene {
  ...
  node(path: "/geo1/boolean1"): BooleanSopNode;
...
export interface PolySceneProps_bvh_demo_boolean {
  ...
  "geo1-boolean1--operation"?: ParamValueSerializedTypeMap["integer"];
  "geo1-boolean1--keepVertexColor"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-boolean1--additionalAttributes"?: ParamValueSerializedTypeMap["string"];
  "geo1-boolean1--keepMaterials"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-boolean1--useInputGroups"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-boolean1--intersectionEdgesOnly"?: ParamValueSerializedTypeMap["boolean"];
