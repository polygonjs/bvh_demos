...
import { PolySceneWithNodeMap_bvh_demo_boolean } from "./PolySceneWithNodeMap";
...
interface LoadedData {
  scene: PolySceneWithNodeMap_bvh_demo_boolean;
...
declare const loadSceneFromSceneData_bvh_demo_boolean: LoadSceneMethod;
