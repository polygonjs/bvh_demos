...
import { PolySceneWithNodeMap_bvh_demo_sdf } from "./PolySceneWithNodeMap";
...
interface LoadedData {
  scene: PolySceneWithNodeMap_bvh_demo_sdf;
...
declare const loadSceneFromSceneData_bvh_demo_sdf: LoadSceneMethod;
