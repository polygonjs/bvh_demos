...
export class PolySceneWithNodeMap_bvh_demo_multiple_rays extends PolyScene {
  ...
  node(path: "/geo1/MAT/lineBasicBuilder1"): LineBasicBuilderMatNode;
...
export interface PolySceneProps_bvh_demo_multiple_rays {
  ...
  "geo1-MAT-lineBasicBuilder1--default"?: ParamValueSerializedTypeMap["folder"];
  "geo1-MAT-lineBasicBuilder1--transparent"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--opacity"?: ParamValueSerializedTypeMap["float"];
  "geo1-MAT-lineBasicBuilder1--alphaTest"?: ParamValueSerializedTypeMap["float"];
  "geo1-MAT-lineBasicBuilder1--advanced"?: ParamValueSerializedTypeMap["folder"];
  "geo1-MAT-lineBasicBuilder1--setBuilderNode"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--builderNode"?: ParamValueSerializedTypeMap["node_path"];
  "geo1-MAT-lineBasicBuilder1--doubleSided"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--front"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--overrideShadowSide"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--shadowDoubleSided"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--shadowFront"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--colorWrite"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--depthWrite"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--depthTest"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--premultipliedAlpha"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--blending"?: ParamValueSerializedTypeMap["integer"];
  "geo1-MAT-lineBasicBuilder1--dithering"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--polygonOffset"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--polygonOffsetFactor"?: ParamValueSerializedTypeMap["integer"];
  "geo1-MAT-lineBasicBuilder1--polygonOffsetUnits"?: ParamValueSerializedTypeMap["integer"];
  "geo1-MAT-lineBasicBuilder1--overrideCustomMaterials"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--createCustomMatDistance"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--createCustomMatDepth"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--createCustomMatDepthDOF"?: ParamValueSerializedTypeMap["boolean"];
  "geo1-MAT-lineBasicBuilder1--linewidth"?: ParamValueSerializedTypeMap["float"];
