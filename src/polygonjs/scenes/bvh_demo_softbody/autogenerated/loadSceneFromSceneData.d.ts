...
import { PolySceneWithNodeMap_bvh_demo_softbody } from "./PolySceneWithNodeMap";
...
interface LoadedData {
  scene: PolySceneWithNodeMap_bvh_demo_softbody;
...
declare const loadSceneFromSceneData_bvh_demo_softbody: LoadSceneMethod;
